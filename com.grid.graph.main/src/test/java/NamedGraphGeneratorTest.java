...
public class NamedGraphGeneratorTest {
    ...
    {
        Graph<String,String> hyperCubeGraph = new SimpleGraph<>(
                SupplierUtil.createStringSupplier(), SupplierUtil.createStringSupplier(), false);
        HyperCubeGraphGenerator<String,String> hyperCubeGenerator =
    ...
    {
        Graph<String,String> completeGraph = new SimpleGraph<>(
                SupplierUtil.createStringSupplier(), SupplierUtil.createStringSupplier(), false);
        CompleteGraphGenerator<String,String> completeGenerator =
