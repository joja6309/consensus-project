...
public class GraphResponse {
    ...
    public GraphResponse(int inputHeight, int inputWidth, Set<String> inputVertices, Set<String> inputEdges, List<String> nodeDeg){
        height = inputHeight;
        width = inputWidth;
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GraphResponse)) return false;
